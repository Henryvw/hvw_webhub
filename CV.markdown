...
<div class="card mb-3 bg-white" style="max-width: 800px;">
  <div class="row g-0">
    <div class="col-md-4 d-flex align-items-center">
      <img src="/assets/images/cv/paper_and_coffee.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
  ...
  <div class="container-fluid">
    <div class="row d-flex align-items-center me-5 ms-2 mb-1">
      <div class="col-md-2 d-flex align-items-center" style="max-width:20%">
        <img src="/assets/images/cv/helpling.jpg" class="m-1" alt="...">
        <img src="/assets/images/cv/finleap.png" class="m-1" alt="...">
        <img src="/assets/images/cv/valendo.jpg" class="m-1" alt="...">
        <img src="/assets/images/cv/drones_per_hour.png" class="m-1" alt="...">
        <img src="/assets/images/cv/movinga.png" class="m-1" alt="...">
        <img src="/assets/images/cv/saas.png" class="m-1" alt="...">
        <img src="/assets/images/cv/juicer.png" class="m-1" alt="..."> 
      </div>
    </div>
  </div>
</div>

<div class="card mb-3 bg-black text-white" style="max-width: 800px;">
  <div class="row g-0">
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text position-absolute top-0 end-0 mt-1 me-3"><small class="text-right">2014-2016</small></p>
      </div>
    </div>
    <div class="col-md-4 d-flex align-items-center">
      <img src="/assets/images/cv/types_of_apps.jpg" class="img-fluid rounded-start" alt="...">
    </div>
  </div>
</div>
...
<div class="card mb-3 bg-black text-white" style="max-width: 800px;">
  <div class="row g-0">
    ...
    <div class="col-md-4 d-flex align-items-center">
      <img src="/assets/images/cv/wh_intern.jpg" class="img-fluid rounded-start" alt="...">
    </div>
  </div>
</div>
...
<div class="card mb-3 bg-danger text-white" style="max-width: 800px;">
  <div class="row g-0">
    ...
    <div class="col-md-4 d-flex align-items-center">
      <img src="/assets/images/cv/sail.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    </div>
</div>

<div class="card mb-3 bg-primary text-white" style="max-width: 800px;">
  <div class="row g-0">
    <div class="col-md-2 d-flex align-items-center mt-3 mb-3 ms-3 me-3">
      <img src="/assets/images/cv/wuerzbuerg.png" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8 ">
      <div class="card-body">
        <h5 class="card-title">Student, Universität Würzburg, Bavaria, Germany</h5> 
        <p class="card-text">Business and Economics</p>
        <p class="card-text position-absolute top-0 end-0 mt-1 me-3"><small class="text-right">2005-2006</small></p>
      </div>
    </div>
  </div>
</div>
...
<div class="card mb-3 bg-primary text-white" style="max-width: 800px;">
  <div class="row g-0">
    <div class="col-md-3 d-flex align-items-center">
      <img src="/assets/images/cv/davidson.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8 ">
      <div class="card-body">
        <h5 class="card-title">Student, Davidson College</h5> 
        <p class="card-text">BA, Liberal Arts <br> Major, English <br> Minor, Economics</p>
        <p class="card-text">Honor Council, Student Solicitor 2006-2007</p>
        <p class="card-text position-absolute top-0 end-0 mt-1 me-3"><small class="text-right">2003-2007</small></p>
      </div>
    </div>
  </div>
</div>
...
<div class="card mb-3 bg-warning text-white" style="max-width: 800px;">
  <div class="row g-0">
    <div class="col-md-2 d-flex align-items-center">
      <img src="/assets/images/cv/SP.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-9 ">
      <div class="card-body">
        <h5 class="card-title">Student, St. Paul's School</h5> 
        <p class="card-text">Founder, <i>The Noisy Bird</i> Student Newspaper</p>
        <p class="card-text position-absolute top-0 end-0 mt-1 me-3"><small class="text-right">1999-2003</small></p>
      </div>
    </div>
  </div>
</div>
...
<div class="card mb-3 bg-indigo text-white" style="max-width: 800px;">
  <div class="row g-0">
    <div class="col-md-3 d-flex align-items-center">
      <img src="/assets/images/cv/farming.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-9 ">
      <div class="card-body">
        ...
        <p class="card-text text-end position-absolute top-0 end-0 mt-1 me-3"><small class="text-muted">2002</small></p>
      </div>
    </div>
  </div>
</div>
...
<div class="card mb-3 bg-success text-white" style="max-width: 800px;">
  <div class="row g-0">
    <div class="col-md-3 d-flex align-items-center">
      <img src="/assets/images/cv/child.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-5 ">
      <div class="card-body">
        <h5 class="card-title">Born On A Farm</h5> 
        <p class="card-text">On the Eastern Shore of Maryland, United States</p>
        <p class="card-text position-absolute top-0 end-0 mt-1 me-3 text-end"><small class="text-muted">1985</small></p>
      </div>
    </div>
    <div class="col-md-4 d-flex align-items-center">
      <img src="/assets/images/cv/eastern_shore.jpg" class="img-fluid rounded-start" alt="...">
    </div>
  </div>
</div>
